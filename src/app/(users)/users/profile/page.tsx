...
const ProfileSection: React.FC<{ user?: User }> = ({ user }) => (
  <div className="mb-8">
    ...
    <div className="flex items-center justify-between  ">
      ...
      <span className="text-xs bg-blue-200 px-2 py-1 rounded ml-2 ">Primary</span>
    </div>
  </div>
);
...
const ConnectedAccountsSection: React.FC<{ connectedAccounts?: ConnectedAccounts }> = ({ connectedAccounts }) => (
  <div>
    ...
    {connectedAccounts?.google && (
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-sm text-gray-500">{connectedAccounts.google}</span>
      </div>
    )}
